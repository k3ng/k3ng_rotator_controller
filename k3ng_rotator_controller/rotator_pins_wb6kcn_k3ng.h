...
#define heading_reading_inhibit_pin 0 // input - a high will cause the controller to suspend taking azimuth (and elevation) readings; use when RF interferes with sensors
  ...
  #define az_incremental_encoder_pin_phase_a 19 //3 must be an interrupt capable pin
  #define az_incremental_encoder_pin_phase_b 18 //3 // must be an interrupt capable pin
  #define az_incremental_encoder_pin_phase_z A15 //4
