...
#if defined(FEATURE_SATELLITE_TRACKING) && !defined(FEATURE_ELEVATION_CONTROL)
  #error "FEATURE_SATELLITE_TRACKING requires FEATURE_ELEVATION_CONTROL"
#endif

#if defined(FEATURE_SATELLITE_TRACKING) && !defined(FEATURE_CLOCK)
